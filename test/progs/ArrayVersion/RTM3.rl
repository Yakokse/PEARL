...
act1: from loop 
      if Q = Q1[pc] && 0=(SLASH = S1[pc]) goto temp else act2

temp: from act1
      if S = S1[pc] goto write else temp2
...
temp2: fi S = S2[pc] from write else temp
       goto act2

act2: fi Q = Q2[pc] && 0=(SLASH = S1[pc]) from temp2 else act1
